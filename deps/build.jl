    ...
    (@build_steps begin
        ...
        @build_steps begin
            ...
            FileRule(joinpath(prefix,"builds","cudautils.so"),@build_steps begin
                `/home/zjt/envs/cuda11.2/bin/nvcc -ptx ../src/cudautils.cu -o cudautils.ptx -arch=compute_35`
                `/home/zjt/envs/cuda11.2/bin/nvcc --shared -Xcompiler -fPIC -shared ../src/cudautils.cu -o cudautils.so -arch=compute_35`
            end)
        end
